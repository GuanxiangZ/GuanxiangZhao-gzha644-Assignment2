...
class Movie:
    ...
    def director(self, director: Director):
        if isinstance(director, Director):
            ...
            director.movie_list.append(self)
        else:
            self.__director = None
...
def make_review(review_text: str, user: User, movie: Movie, rating : int, timestamp: datetime = datetime.now()):
